class AbilityLoadedWeapons extends AdjustCost
	config(fpsRPG) 
	abstract;

var config Array< String > Level1;
var config Array< String > Level2;
var config Array< String > Level3;
...
static function ModifyPawn(Pawn Other, int AbilityLevel)
{
	...
	for(x = 0; x < default.Level1.length; x++)
		giveWeapon(Other, default.Level1[x], AbilityLevel, RPGMut);
	for(x = 0; AbilityLevel >= 2 && x < default.Level2.length; x++)
		giveWeapon(Other, default.Level2[x], AbilityLevel, RPGMut);
	for(x = 0; Other.Level.Game.IsA('Invasion') && AbilityLevel >= 3 && x < default.Level3.length; x++)
		giveWeapon(Other, default.Level3[x], AbilityLevel, RPGMut);
...
defaultproperties
{
     Level1(0)="XWeapons.RocketLauncher"
     Level1(1)="XWeapons.ShockRifle"
     Level1(2)="fpsRPG.RPGLinkGun"
     Level1(3)="XWeapons.SniperRifle"
     Level1(4)="XWeapons.FlakCannon"
     Level1(5)="XWeapons.MiniGun"
     Level1(6)="XWeapons.BioRifle"
     Level2(0)="UTClassic.ClassicSniperRifle"
     Level2(1)="Onslaught.ONSGrenadeLauncher"
     Level2(2)="Onslaught.ONSAVRiL"
     Level2(3)="Onslaught.ONSMineLayer"
     Level3(0)="XWeapons.Redeemer"
     Level3(1)="XWeapons.Painter"
     MinLev2=40
     MinLev3=55
     AbilityName="ÿLoaded Weapons"
     Description="When you spawn:|Level 1: You are granted all default weapons with the default percentage chance for magic weapons.|Level 2: You are granted onslaught weapons and all weapons with max ammo.|Level 3: You are granted super weapons (Invasion game types only).|Level 4: Magic weapons will be generated for all your weapons.|Level 5: You receive all positive magic weapons.|You must be level 40 before you can buy level 2 and level 55 before you can buy level 3.|Cost (per level): 15,20,25,30,35"
     StartingCost=15
     CostAddPerLevel=5
     MaxLevel=5
}
