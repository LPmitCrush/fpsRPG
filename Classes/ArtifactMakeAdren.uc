class ArtifactMakeAdren extends RPGArtifact;
...
static function string GetLocalString (optional int Switch, optional PlayerReplicationInfo RelatedPRI_1, optional PlayerReplicationInfo RelatedPRI_2)
{
  if ( Switch == 2000 )
  {
    return "Unable to create Adren weapon.";
  }
  if ( Switch == 3000 )
  {
    return "Unable to create Adren Super weapons.";
  }
  if ( Switch == 4000 )
  {
...
defaultproperties
{
  ...
  IconMaterial=Texture'fpsRPGTex.Modifiers.InfAdrenIcon' // Set Icons here
  ItemName="Infinity Adren Maker"
}
