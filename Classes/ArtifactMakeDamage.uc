class ArtifactMakeDamage extends RPGArtifact;
...
function RollToInInite ()
{
  ...
  NewWeaponClass = Class'RW_Damage';
...
static function string GetLocalString (optional int Switch, optional PlayerReplicationInfo RelatedPRI_1, optional PlayerReplicationInfo RelatedPRI_2)
{
  if ( Switch == 2000 )
  {
    return "Unable to create Damage weapon.";
  }
  if ( Switch == 3000 )
  {
    return "Unable to create Damage Super weapons, use Magic Weapon Maker";
  }
  if ( Switch == 4000 )
  {
...
defaultproperties
{
  ...
  IconMaterial=Texture'fpsRPGTex.Modifiers.DamageIcon' // Set Icons here
  ItemName="Damage Maker"
}
