class ArtifactMakeEnergy extends RPGArtifact;
...
function RollToInInite ()
{
  ...
  NewWeaponClass = Class'RW_Energy';
...
static function string GetLocalString (optional int Switch, optional PlayerReplicationInfo RelatedPRI_1, optional PlayerReplicationInfo RelatedPRI_2)
{
  if ( Switch == 2000 )
  {
    return "Unable to create Energy weapon.";
  }
  if ( Switch == 3000 )
  {
    return "Unable to create Energy Super weapons, use Magic Weapon Maker";
  }
  if ( Switch == 4000 )
  {
...
defaultproperties
{
  ...
  IconMaterial=Texture'fpsRPGTex.Modifiers.EnergyIcon' // Set Icons here
  ItemName="Energy Maker"
}
