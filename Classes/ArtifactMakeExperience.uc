class ArtifactMakeExperience extends RPGArtifact;
...
function RollToInInite ()
{
  ...
  NewWeaponClass = Class'RW_Experience';
...
static function string GetLocalString (optional int Switch, optional PlayerReplicationInfo RelatedPRI_1, optional PlayerReplicationInfo RelatedPRI_2)
{
  if ( Switch == 2000 )
  {
    return "Unable to create Experience weapon.";
  }
  if ( Switch == 3000 )
  {
    return "Unable to create Experience Super weapons.";
  }
  if ( Switch == 4000 )
  {
...
defaultproperties
{
  ...
  IconMaterial=Texture'fpsRPGTex.Modifiers.ExperienceIcon' // Set Icons here
  ItemName="Experience Maker"
}
