class ArtifactMakeForce extends RPGArtifact;
...
static function string GetLocalString (optional int Switch, optional PlayerReplicationInfo RelatedPRI_1, optional PlayerReplicationInfo RelatedPRI_2)
{
  if ( Switch == 2000 )
  {
    return "Unable to create Force weapon.";
  }
  if ( Switch == 3000 )
  {
    return "Unable to create Force Super weapons, use Magic Weapon Maker";
  }
  if ( Switch == 4000 )
  {
...
defaultproperties
{
  ...
  IconMaterial=Texture'fpsRPGTex.Modifiers.ForceIcon' // Set Icons here
  ItemName="Force Maker"
}
