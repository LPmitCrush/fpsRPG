class ArtifactMakeFreeze extends RPGArtifact;
...
function RollToInInite ()
{
  ...
  NewWeaponClass = Class'RW_Freeze';
...
static function string GetLocalString (optional int Switch, optional PlayerReplicationInfo RelatedPRI_1, optional PlayerReplicationInfo RelatedPRI_2)
{
  if ( Switch == 2000 )
  {
    return "Unable to create Freezing Weapon.";
  }
  if ( Switch == 3000 )
  {
    return "Unable to create Freeze on Super Weapons.";
  }
  if ( Switch == 4000 )
  {
...
defaultproperties
{
  ...
  IconMaterial=Texture'fpsRPGTex.Modifiers.FreezeIcon' // Set Icons here
  ItemName="Freeze Maker"
}
