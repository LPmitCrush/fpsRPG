class ArtifactMakeHealing extends RPGArtifact;
...
function RollToInInite ()
{
  ...
  NewWeaponClass = Class'RW_Healing';
...
static function string GetLocalString (optional int Switch, optional PlayerReplicationInfo RelatedPRI_1, optional PlayerReplicationInfo RelatedPRI_2)
{
  if ( Switch == 2000 )
  {
    return "Unable to create an Healing Weapon.";
  }
  if ( Switch == 3000 )
  {
    return "Unable to create Healing on Super Weapons.";
  }
  if ( Switch == 4000 )
  {
...
defaultproperties
{
  ...
  IconMaterial=Texture'fpsRPGTex.Modifiers.PoisonIcon' // Set Icons here
  ItemName="Healing Maker"
}
