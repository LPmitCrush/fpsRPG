class ArtifactMakeInfinity extends RPGArtifact;
...
function RollToInInite ()
{
  ...
  NewWeaponClass = Class'RW_Infinity';
...
static function string GetLocalString (optional int Switch, optional PlayerReplicationInfo RelatedPRI_1, optional PlayerReplicationInfo RelatedPRI_2)
{
  if ( Switch == 2000 )
  {
    return "Unable to create Infinity weapon.";
  }
  if ( Switch == 3000 )
  {
    return "Unable to create Infinity Super weapons.";
  }
  if ( Switch == 4000 )
  {
...
defaultproperties
{
  ...
  IconMaterial=Texture'fpsRPGTex.Modifiers.InfinityIcon' // Set Icons here
  ItemName="Infinity Maker"
}
