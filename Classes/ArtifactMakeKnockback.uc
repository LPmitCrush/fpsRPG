class ArtifactMakeKnockback extends RPGArtifact;
...
function RollToInInite ()
{
  ...
  NewWeaponClass = Class'RW_Knockback';
...
static function string GetLocalString (optional int Switch, optional PlayerReplicationInfo RelatedPRI_1, optional PlayerReplicationInfo RelatedPRI_2)
{
  if ( Switch == 2000 )
  {
    return "Unable to create an Knockback Weapon.";
  }
  if ( Switch == 3000 )
  {
    return "Unable to use Knockback on Super Weapons.";
  }
  if ( Switch == 4000 )
  {
...
defaultproperties
{
  ...
  IconMaterial=Texture'fpsRPGTex.Modifiers.KnockbackIcon' // Set Icons here
  ItemName="Knockback Maker"
}
