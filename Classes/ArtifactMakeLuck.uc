class ArtifactMakeLuck extends RPGArtifact;
...
static function string GetLocalString (optional int Switch, optional PlayerReplicationInfo RelatedPRI_1, optional PlayerReplicationInfo RelatedPRI_2)
{
  if ( Switch == 2000 )
  {
    return "Unable to create an Lucky Weapon.";
  }
  if ( Switch == 3000 )
  {
    return "You are not Lucky enough to use it on Super Weapons";
  }
  if ( Switch == 4000 )
  {
...
defaultproperties
{
  ...
  IconMaterial=Texture'fpsRPGTex.Modifiers.LuckyIcon' // Set Icons here
  ItemName="Lucky Maker"
}
