class ArtifactMakePetrification extends RPGArtifact;
...
function RollToInInite ()
{
  ...
  NewWeaponClass = Class'RW_NullEntropy';
...
static function string GetLocalString (optional int Switch, optional PlayerReplicationInfo RelatedPRI_1, optional PlayerReplicationInfo RelatedPRI_2)
{
  if ( Switch == 2000 )
  {
    return "Unable to create an Petrification Weapon.";
  }
  if ( Switch == 3000 )
  {
    return "Unable to create Petrification on Super Weapons.";
  }
  if ( Switch == 4000 )
  {
...
defaultproperties
{
  ...
  IconMaterial=Texture'XGameTextures.SuperPickups.Udamage' // Set Icons here
  ItemName="Petrification Maker"
}
