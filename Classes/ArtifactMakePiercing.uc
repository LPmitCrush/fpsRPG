class ArtifactMakePiercing extends RPGArtifact;
...
function RollToInInite ()
{
  ...
  NewWeaponClass = Class'RW_Piercing';
...
static function string GetLocalString (optional int Switch, optional PlayerReplicationInfo RelatedPRI_1, optional PlayerReplicationInfo RelatedPRI_2)
{
  if ( Switch == 2000 )
  {
    return "Unable to create an Piercing Weapon.";
  }
  if ( Switch == 3000 )
  {
    return "Unable to create Piercing on Super Weapons.";
  }
  if ( Switch == 4000 )
  {
...
defaultproperties
{
  ...
  IconMaterial=Texture'fpsRPGTex.Modifiers.PiercingIcon' // Set Icons here
  ItemName="Piercing Maker"
}
