class ArtifactMakePoison extends RPGArtifact;
...
function RollToInInite ()
{
  ...
  NewWeaponClass = Class'RW_Poison';
...
static function string GetLocalString (optional int Switch, optional PlayerReplicationInfo RelatedPRI_1, optional PlayerReplicationInfo RelatedPRI_2)
{
  if ( Switch == 2000 )
  {
    return "Unable to create an Poison Weapon.";
  }
  if ( Switch == 3000 )
  {
    return "Unable to create Poison on Super Weapons.";
  }
  if ( Switch == 4000 )
  {
