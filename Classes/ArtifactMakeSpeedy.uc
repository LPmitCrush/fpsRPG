class ArtifactMakeSpeedy extends RPGArtifact;
...
function RollToInInite ()
{
  ...
  NewWeaponClass = Class'RW_Speedy';
...
static function string GetLocalString (optional int Switch, optional PlayerReplicationInfo RelatedPRI_1, optional PlayerReplicationInfo RelatedPRI_2)
{
  if ( Switch == 2000 )
  {
    return "Unable to create an Quickfoot Weapon.";
  }
  if ( Switch == 3000 )
  {
    return "Unable to create Quickfoot on Super Weapons.";
  }
  if ( Switch == 4000 )
  {
...
defaultproperties
{
  ...
  IconMaterial=Texture'fpsRPGTex.Modifiers.SpeedIcon' // Set Icons here
  ItemName="Quickfoot Maker"
}
