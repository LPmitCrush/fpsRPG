class ArtifactMakeSturdy extends RPGArtifact;
...
function RollToInInite ()
{
  ...
  NewWeaponClass = Class'RW_NoMomentum';
...
static function string GetLocalString (optional int Switch, optional PlayerReplicationInfo RelatedPRI_1, optional PlayerReplicationInfo RelatedPRI_2)
{
  if ( Switch == 2000 )
  {
    return "Unable to create an Sturdy Weapon.";
  }
  if ( Switch == 3000 )
  {
    return "Unable to create Sturdy on Super Weapons.";
  }
  if ( Switch == 4000 )
  {
...
defaultproperties
{
  ...
  IconMaterial=Texture'fpsRPGTex.Modifiers.SturdyIcon' // Set Icons here
  ItemName="Sturdy Maker"
}
