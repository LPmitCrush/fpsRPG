class ArtifactMakeVampire extends RPGArtifact;
...
function RollToInInite ()
{
  ...
  NewWeaponClass = Class'RW_Vampire';
...
static function string GetLocalString (optional int Switch, optional PlayerReplicationInfo RelatedPRI_1, optional PlayerReplicationInfo RelatedPRI_2)
{
  if ( Switch == 2000 )
  {
    return "Unable to create Vamprism Weapon.";
  }
  if ( Switch == 3000 )
  {
    return "Unable to create Vampirism on Super Weapons.";
  }
  if ( Switch == 4000 )
  {
