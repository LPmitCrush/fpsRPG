class ArtifactMakeVorpal extends RPGArtifact;
...
function RollToInInite ()
{
  ...
  NewWeaponClass = Class'RW_Vorpal';
...
static function string GetLocalString (optional int Switch, optional PlayerReplicationInfo RelatedPRI_1, optional PlayerReplicationInfo RelatedPRI_2)
{
  if ( Switch == 2000 )
  {
    return "Unable to create an Vorpal Weapon.";
  }
  if ( Switch == 3000 )
  {
    return "Unable to create Vorpal on Super weapons.";
  }
  if ( Switch == 4000 )
  {
...
defaultproperties
{
  ...
  IconMaterial=Texture'fpsRPGTex.Modifiers.VorpalIcon' // Set Icons here
  ItemName="Vorpal Maker"
}
