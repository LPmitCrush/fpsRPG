class ArtifactTripleDamageB extends ArtifactTripleDamage
	config(fpsRPG);
...
function Activate()
{
	Local ArtifactDoubleModifier dbl;
	dbl = ArtifactDoubleModifier(Instigator.findInventoryType(class'ArtifactDoubleModifier'));
...
defaultproperties
{
     ...
     CostPerSec=12
     PickupClass=Class'fpsRPG.ArtifactTripleDamagePickupB'
}
