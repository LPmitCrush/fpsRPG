		...
		if(OldWeapon != None)
		{
			...
			(
				(
					...
					class'MutfpsRPG'.static.IsSuperWeaponAmmo(OldWeapon.default.FireModeClass[0].default.AmmoClass)
				) ||
				(
					...
					class'MutfpsRPG'.static.IsSuperWeaponAmmo(OldWeapon.default.FireModeClass[1].default.AmmoClass)
				)
			)
			{
...
defaultproperties
{
     ...
     PickupClass=Class'fpsRPG.DruidArtifactMakeMagicWeaponPickup'
