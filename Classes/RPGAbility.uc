...
/* Called by MutfpsRPG during its first tick. Return false to be removed from ability list (for example, if the
...
/* Modify the player's pawn. Called by MutfpsRPG.ModifyPlayer() on the server side, and by
...
/* Modify the owning player's current vehicle. Called by MutfpsRPG.DriverEnteredVehicle() serverside
