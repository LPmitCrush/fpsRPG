...
defaultproperties
{
     ArtifactDelay=30
     MaxArtifacts=6
     AvailableArtifacts(0)=(ArtifactClass=Class'fpsRPG.ArtifactInvulnerability',Chance=1)
     AvailableArtifacts(1)=(ArtifactClass=Class'fpsRPG.ArtifactFlight',Chance=1)
     AvailableArtifacts(2)=(ArtifactClass=Class'fpsRPG.ArtifactTripleDamage',Chance=1)
     AvailableArtifacts(3)=(ArtifactClass=Class'fpsRPG.ArtifactLightningRod',Chance=1)
     AvailableArtifacts(4)=(ArtifactClass=Class'fpsRPG.ArtifactTeleport',Chance=1)
     AvailableArtifacts(5)=(ArtifactClass=Class'fpsRPG.ArtifactMonsterSummon',Chance=1)
