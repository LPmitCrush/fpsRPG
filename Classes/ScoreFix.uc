...
function PreBeginPlay()
{
	...
	class'MutfpsRPG'.default.LevelDiffExpGainDiv = ScoreConfigs[gameType].LevelDiffExpGainDiv;
	class'MutfpsRPG'.default.EXPForWin=ScoreConfigs[gameType].EXPForWin;
	class'MutfpsRPG'.default.bIronmanMode=ScoreConfigs[gameType].IronMan;
	class'MutfpsRPG'.default.WeaponModifierChance=ScoreConfigs[gameType].WeaponModifierChance;
	if(ScoreConfigs[gameType].WeaponModifierChance == 0)
	    class'MutfpsRPG'.default.bMagicalStartingWeapons = False;
	else
	    class'MutfpsRPG'.default.bMagicalStartingWeapons = True;

	class'MutfpsRPG'.static.StaticSaveConfig();
}
